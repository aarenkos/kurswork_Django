    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('regularity', models.CharField(choices=[('daily', 'Ежедневно'), ('weekly', 'Еженедельно'), ('monthly', 'Ежемесячно')], max_length=10, verbose_name='периодичность')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client', models.ManyToManyField(related_name='logs', to='mailing.client', verbose_name='клиент')),
                ('mailing_list', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='logs', to='mailing.mailing', verbose_name='рассылка')),
            ],
            options={
